...
function HorizontalTagListPreview() {
  return (
...
const examples: DevExample[] = [
  ...
  },
  {
    ...
    preview: <HorizontalTagListPreview />,
  },
];

export default function ScrollExamplesPage() {
  return (
    <DevExampleLayout
      title="Scroll Examples"
      description="Constrained scroll regions with custom scrollbar, fade masks, and horizontal overflow."
      examples={examples}
