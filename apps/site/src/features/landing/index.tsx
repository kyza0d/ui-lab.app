          ...
          <div className="flex items-center text-center flex-col pt-8 md:pt-0">
            <div className="flex gap-2 mb-4">
              <span className="flex h-[32px] font-medium items-center overflow-hidden gap-[9px] bg-background-950 border border-background-700 rounded-[8px] text-foreground-300 text-sm pl-[3px]">
                <div className="flex text-xs items-center text-accent-500 bg-accent-500/30 border-l-[1px] rounded-[5px] h-[20px] border-background-700 mr-[4px] px-[4px]"><FaTags /></div>
                Release Notes
                <span className="bg-background-800/50 border-l border-background-700 h-full font-semibold pt-1 px-3">
                  v0.1.5
                </span>
              </span>
            </div>
