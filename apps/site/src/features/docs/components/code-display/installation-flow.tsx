  ...
  return (
    <div className="space-y-8">
      <section className="space-y-4">
        <h3
          id="target-framework"
          className="text-lg font-semibold text-foreground-200 pb-6 scroll-mt-20"
        >
          Target framework
        </h3>
