  ...
  return (
    <div ref={containerRef} className="pt-(--header-height) mx-auto" style={{ '--header-height': '3.75rem' } as React.CSSProperties}>
      ...
      <main className="mx-auto h-full max-w-[1100px] ">
        ...
        <div>
          <section className="border-x border-background-700 relative isolate after:content-[''] bg-background-950 ml-auto grid grid-cols-[1fr] grid-rows-[480px]">
            <HeroSection
                  ...
                  {[
                    ...
                    <div key={name}>
                      <a
                        ...
                        className="relative my-[6px] p-[10px] flex justify-start items-start flex-row gap-8 rounded-[10px] border-[2px] border-background-700 bg-background-800/50 backdrop-blur-sm transition-all hover:border-background-600 hover:bg-background-800 cursor-pointer"
                      >
                        <Icon />
