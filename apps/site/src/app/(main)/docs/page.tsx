          ...
          <section id="requirements" className="my-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { Icon: SiReact, name: 'React', version: 'v19.1', href: 'https://react.dev/' },
                { Icon: ReactAriaSvg, name: 'React Aria', version: 'v3.4', href: 'https://react-spectrum.adobe.com/react-aria/' },
                { Icon: SiTypescript, name: 'TypeScript', version: 'v5.8', href: 'https://www.typescriptlang.org/' },
              ].map(({ Icon, name, version, href }) => (
                <a
                  key={name}
                  href={href}
                  target="_blank"
