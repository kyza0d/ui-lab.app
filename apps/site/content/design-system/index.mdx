...
- **Designers**: Review [Colors](/design-system/colors), [Typography](/design-system/typography), and [Spacing](/design-system/spacing)
- **Developers**: Learn about [Tokens](/design-system/tokens) and [Component Guidelines](/design-system/component-guidelines)
- **Teams**: Understand [Accessibility](/design-system/accessibility) requirements

---

## Core Pillars

### <Icon name="Layers" className="inline bg-background-800 border border-background-700 w-10 h-10 rounded-sm text-foreground-400 p-2 mr-2" /> Foundation
...
### <Icon name="CircleDot" className="inline bg-background-800 border border-background-700 w-10 h-10 rounded-sm text-foreground-400 p-2 mr-2" /> Tokens
...
### <Icon name="Component" className="inline bg-background-800 border border-background-700 w-10 h-10 rounded-sm text-foreground-400 p-2 mr-2" /> Components
...
### <Icon name="BookOpen" className="inline bg-background-800 border border-background-700 w-10 h-10 rounded-sm text-foreground-400 p-2 mr-2" /> Guidelines
...
- **[Colors](/design-system/colors)** — Color palette, OKLCH values, and usage guidelines
- **[Typography](/design-system/typography)** — Type scale, font families, and text styling
- **[Spacing](/design-system/spacing)** — Spacing scale and layout rhythms
- **[Tokens](/design-system/tokens)** — Complete token reference and implementation
- **[Component Guidelines](/design-system/component-guidelines)** — Building components with the system
- **[Accessibility](/design-system/accessibility)** — Detailed WCAG compliance and testing
