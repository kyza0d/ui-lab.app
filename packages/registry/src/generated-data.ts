...
export const generatedStyles: Record<string, ComponentStyles> = {
  ...
  "banner": "@reference \"tailwindcss\";\n\n@layer components {\n  .banner {\n    --background: var(--info-900);\n    --foreground: var(--info-50);\n    --border: var(--info-800);\n\n    width: 100%;\n    display: flex;\n    align-items: flex-start;\n    justify-content: space-between;\n    gap: var(--spacing-4);\n    font-family: inherit;\n    font-size: var(--text-md);\n    line-height: var(--leading-normal);\n    background-color: var(--background);\n    color: var(--foreground);\n    border: var(--border-width-base) solid var(--border);\n    border-radius: var(--radius-md);\n    transition: background-color 0.15s ease-out, border-color 0.15s ease-out;\n  }\n\n  .content {\n    flex: 1;\n    display: flex;\n    flex-direction: column;\n    gap: var(--spacing-2);\n  }\n\n  .iconContainer {\n    flex-shrink: 0;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    align-self: flex-start;\n  }\n\n  .icon {\n    @apply mr-4;\n    width: 1.25rem;\n    height: 1.25rem;\n    color: currentColor;\n  }\n\n  .dismiss {\n    flex-shrink: 0;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    width: 32px;\n    height: 32px;\n    padding: 0;\n    background-color: transparent;\n    color: currentColor;\n    border: none;\n    border-radius: var(--radius-sm);\n    cursor: pointer;\n    transition: background-color 0.15s ease-out;\n\n    &:focus-visible {\n      outline: 2px solid currentColor;\n      outline-offset: 2px;\n    }\n\n    @media (hover: hover) {\n      &:hover {\n        background-color: rgba(0, 0, 0, 0.1);\n      }\n    }\n  }\n\n  .title {\n    font-weight: var(--font-weight-semibold);\n    font-size: inherit;\n    line-height: var(--leading-tight);\n    margin: 0;\n  }\n\n  .body {\n    font-weight: var(--font-weight-normal);\n    font-size: inherit;\n    line-height: var(--leading-normal);\n    margin: 0;\n    color: currentColor;\n    opacity: 0.9;\n  }\n}\n\n.banner.note {\n  --background: var(--background-800);\n  --foreground: var(--foreground-200);\n  --border: var(--background-700);\n}\n\n.banner.note .icon {\n  color: var(--background-400);\n}\n\n.banner.info {\n  --background: color-mix(in srgb, var(--info-600) 10%, transparent);\n  --foreground: var(--foreground-200);\n  --border: color-mix(in srgb, var(--info-600) 40%, transparent);\n}\n\n.banner.info .icon {\n  color: var(--info-500);\n}\n\n.banner.success {\n  --background: color-mix(in srgb, var(--success-600) 10%, transparent);\n  --foreground: var(--foreground-200);\n  --border: color-mix(in srgb, var(--success-600) 40%, transparent);\n}\n\n.banner.success .icon {\n  color: var(--success-500);\n}\n\n.banner.warning {\n  --background: color-mix(in srgb, var(--warning-600) 10%, transparent);\n  --foreground: var(--foreground-200);\n  --border: color-mix(in srgb, var(--warning-600) 40%, transparent);\n}\n\n.banner.warning .icon {\n  color: var(--warning-500);\n}\n\n.banner.danger {\n  --background: color-mix(in srgb, var(--danger-600) 10%, transparent);\n  --foreground: var(--foreground-200);\n  --border: color-mix(in srgb, var(--danger-600) 40%, transparent);\n}\n\n.banner.danger .icon {\n  color: var(--danger-500);\n}\n\n.banner.sm {\n  @apply px-3 py-2;\n  font-size: var(--text-sm);\n}\n\n.banner.md {\n  @apply px-4 py-3;\n  font-size: var(--text-sm);\n}\n\n.banner.lg {\n  @apply px-6 py-4;\n  font-size: var(--text-lg);\n}\n\n@media (hover: hover) {\n  .banner:hover {\n    background-color: color-mix(in srgb, var(--background) 90%, black);\n  }\n}\n",
