...
export const generatedStyles: Record<string, ComponentStyles> = {
  ...
  "grid": "@reference \"tailwindcss\";\n\n@layer components {\n  .grid {\n    display: grid;\n    width: 100%;\n    grid-template-columns: var(--grid-tpl, repeat(3, 1fr));\n    grid-template-rows: var(--grid-rows, auto);\n    gap: var(--grid-gap, var(--spacing-md, 1rem));\n    justify-items: var(--grid-ji, stretch);\n    align-items: var(--grid-ai, stretch);\n    justify-content: var(--grid-jc, start);\n    align-content: var(--grid-ac, start);\n    grid-auto-flow: var(--grid-flow, row);\n  }\n\n  .container {\n    container-type: inline-size;\n    container-name: grid-ctx;\n  }\n\n  .grid.responsive-cols {\n    grid-template-columns: var(--grid-tpl-sm, 1fr);\n  }\n\n  @media (min-width: 640px) {\n    .grid.responsive-cols {\n      grid-template-columns: var(--grid-tpl-md, var(--grid-tpl-sm, 1fr));\n    }\n  }\n\n  @media (min-width: 1024px) {\n    .grid.responsive-cols {\n      grid-template-columns: var(--grid-tpl-lg, var(--grid-tpl-md, var(--grid-tpl-sm, 1fr)));\n    }\n  }\n\n  @media (min-width: 1280px) {\n    .grid.responsive-cols {\n      grid-template-columns: var(--grid-tpl-xl, var(--grid-tpl-lg, var(--grid-tpl-md, var(--grid-tpl-sm, 1fr))));\n    }\n  }\n\n  .grid.responsive-gap {\n    gap: var(--grid-gap-sm, var(--spacing-sm, 0.5rem));\n  }\n\n  @media (min-width: 640px) {\n    .grid.responsive-gap {\n      gap: var(--grid-gap-md, var(--grid-gap-sm, var(--spacing-md, 1rem)));\n    }\n  }\n\n  @media (min-width: 1024px) {\n    .grid.responsive-gap {\n      gap: var(--grid-gap-lg, var(--grid-gap-md, var(--grid-gap-sm, var(--spacing-md, 1rem))));\n    }\n  }\n\n  @media (min-width: 1280px) {\n    .grid.responsive-gap {\n      gap: var(--grid-gap-xl, var(--grid-gap-lg, var(--grid-gap-md, var(--grid-gap-sm, var(--spacing-md, 1rem)))));\n    }\n  }\n\n  .grid.responsive-rows {\n    grid-template-rows: var(--grid-rows-sm, auto);\n  }\n\n  @media (min-width: 640px) {\n    .grid.responsive-rows {\n      grid-template-rows: var(--grid-rows-md, var(--grid-rows-sm, auto));\n    }\n  }\n\n  @media (min-width: 1024px) {\n    .grid.responsive-rows {\n      grid-template-rows: var(--grid-rows-lg, var(--grid-rows-md, var(--grid-rows-sm, auto)));\n    }\n  }\n\n  @media (min-width: 1280px) {\n    .grid.responsive-rows {\n      grid-template-rows: var(--grid-rows-xl, var(--grid-rows-lg, var(--grid-rows-md, var(--grid-rows-sm, auto))));\n    }\n  }\n\n  .grid.has-row-gap {\n    row-gap: var(--grid-row-gap);\n  }\n\n  .grid.has-col-gap {\n    column-gap: var(--grid-col-gap);\n  }\n\n  @container grid-ctx (width < 400px) {\n    .container .grid {\n      grid-template-columns: 1fr;\n      gap: var(--spacing-sm, 0.5rem);\n    }\n  }\n}\n",
  "group": "@reference \"tailwindcss\";\n\n@layer components {\n  /* Container */\n  .group {\n    --background: var(--background-950);\n    --border: var(--background-700);\n\n    display: flex;\n    width: fit-content;\n    background-color: var(--background);\n    border: var(--border-width-base) solid var(--border);\n    border-radius: var(--radius-sm);\n    overflow: hidden;\n  }\n\n  /* Orientations */\n  .group.horizontal {\n    flex-direction: row;\n    align-items: stretch;\n  }\n\n  .group.vertical {\n    flex-direction: column;\n  }\n\n  /* Spacing */\n  .group.none {\n    @apply p-0 gap-0;\n  }\n\n  .group.sm {\n    @apply p-1 gap-1;\n  }\n\n  /* Variants */\n  .group.ghost {\n    --background: transparent;\n    background-color: transparent;\n    border: none;\n    overflow: visible;\n    @apply gap-1;\n  }\n\n  .itemWrapper {\n    /* Spacing is handled by group's gap property */\n    display: flex;\n    align-items: stretch;\n  }\n\n  /* Override child component styles when in group */\n  .group:not(.ghost) .itemWrapper .groupItem,\n  .group:not(.ghost) .groupInputWrapper input,\n  .group:not(.ghost) .itemWrapper .groupSelectWrapper {\n    border: none;\n  }\n\n  /* spacing=\"none\": Remove radius from all items (merged appearance) */\n  .group.none:not(.ghost) .itemWrapper .groupItem,\n  .group.none:not(.ghost) .groupInputWrapper input,\n  .group.none:not(.ghost) .itemWrapper .groupSelectWrapper,\n  .group.none:not(.ghost) .itemWrapper .trigger {\n    border-radius: 0;\n  }\n\n  /* spacing=\"sm\": Apply full radius to all items (separated appearance) */\n  .group.sm:not(.ghost) .itemWrapper .groupItem,\n  .group.sm:not(.ghost) .itemWrapper .trigger,\n  .group.sm:not(.ghost) .groupSelectWrapper .groupItem,\n  .group.sm:not(.ghost) .groupSelectWrapper .trigger {\n    border-radius: var(--radius-sm);\n  }\n\n  .group.sm:not(.ghost) .groupInputWrapper input {\n    border-radius: var(--radius-sm);\n  }\n\n  /* spacing=\"none\": Apply radius to first and last items only (merged edges) */\n  .group.none.horizontal:not(.ghost) .itemWrapper:first-child > .groupItem {\n    border-top-left-radius: var(--radius-sm);\n    border-bottom-left-radius: var(--radius-sm);\n  }\n\n  .group.none.horizontal:not(.ghost) .itemWrapper:last-child > .groupItem {\n    border-top-right-radius: var(--radius-sm);\n    border-bottom-right-radius: var(--radius-sm);\n  }\n\n  .group.none.vertical:not(.ghost) .itemWrapper:first-child > .groupItem {\n    border-top-left-radius: var(--radius-sm);\n    border-top-right-radius: var(--radius-sm);\n  }\n\n  .group.none.vertical:not(.ghost) .itemWrapper:last-child > .groupItem {\n    border-bottom-left-radius: var(--radius-sm);\n    border-bottom-right-radius: var(--radius-sm);\n  }\n\n  /* spacing=\"none\": Apply radius to first/last inputs (merged edges) */\n  .group.none.horizontal:not(.ghost) .itemWrapper:first-child .groupInputWrapper input {\n    border-top-left-radius: var(--radius-sm);\n    border-bottom-left-radius: var(--radius-sm);\n  }\n\n  .group.none.horizontal:not(.ghost) .itemWrapper:last-child .groupInputWrapper input {\n    border-top-right-radius: var(--radius-sm);\n    border-bottom-right-radius: var(--radius-sm);\n  }\n\n  .group.none.vertical:not(.ghost) .itemWrapper:first-child .groupInputWrapper input {\n    border-top-left-radius: var(--radius-sm);\n    border-top-right-radius: var(--radius-sm);\n  }\n\n  .group.none.vertical:not(.ghost) .itemWrapper:last-child .groupInputWrapper input {\n    border-bottom-left-radius: var(--radius-sm);\n    border-bottom-right-radius: var(--radius-sm);\n  }\n\n  /* spacing=\"none\": Apply radius to Button and Trigger within Group.Select (split-action pattern) */\n  .group.none.horizontal:not(.ghost) .groupSelectWrapper .groupItem {\n    border-top-left-radius: var(--radius-sm);\n    border-bottom-left-radius: var(--radius-sm);\n  }\n\n  .group.none.horizontal:not(.ghost) .groupSelectWrapper .trigger {\n    border-top-right-radius: var(--radius-sm);\n    border-bottom-right-radius: var(--radius-sm);\n  }\n\n  .group.none.vertical:not(.ghost) .groupSelectWrapper .groupItem {\n    border-top-left-radius: var(--radius-sm);\n    border-top-right-radius: var(--radius-sm);\n  }\n\n  .group.none.vertical:not(.ghost) .groupSelectWrapper .trigger {\n    border-bottom-left-radius: var(--radius-sm);\n    border-bottom-right-radius: var(--radius-sm);\n  }\n\n  /* spacing=\"none\": Apply radius to triggers in first/last position (for standalone triggers) */\n  .group.none.horizontal:not(.ghost) .itemWrapper:first-child > .trigger {\n    border-top-left-radius: var(--radius-sm);\n    border-bottom-left-radius: var(--radius-sm);\n  }\n\n  .group.none.horizontal:not(.ghost) .itemWrapper:last-child > .trigger {\n    border-top-right-radius: var(--radius-sm);\n    border-bottom-right-radius: var(--radius-sm);\n  }\n\n  .group.none.vertical:not(.ghost) .itemWrapper:first-child > .trigger {\n    border-top-left-radius: var(--radius-sm);\n    border-top-right-radius: var(--radius-sm);\n  }\n\n  .group.none.vertical:not(.ghost) .itemWrapper:last-child > .trigger {\n    border-bottom-left-radius: var(--radius-sm);\n    border-bottom-right-radius: var(--radius-sm);\n  }\n\n  /* Separator styling for automatic dividers */\n  .separator {\n    background-color: var(--background-700);\n    flex-shrink: 0;\n  }\n\n  .group.horizontal .separator {\n    width: 1px;\n    align-self: stretch;\n  }\n\n  .group.vertical .separator {\n    width: 100%;\n    height: 1px;\n  }\n\n  /* Ghost variant */\n  .group.ghost .itemWrapper .groupItem:not(.active) {\n    border-radius: var(--radius-sm);\n    border: var(--border-width-base) solid transparent;\n  }\n\n  /* Focus styles - box-shadow follows border-radius */\n  .group:not(.ghost) .itemWrapper .groupItem:focus-visible,\n  .group:not(.ghost) .itemWrapper .trigger:focus-visible,\n  .groupInputWrapper input:focus-visible {\n    outline: none;\n    box-shadow: inset 0 0 0 2px var(--accent-500);\n    position: relative;\n    z-index: 1;\n  }\n\n  .group.ghost .itemWrapper .groupItem:focus-visible,\n  .group.ghost .itemWrapper .trigger:focus-visible {\n    outline: none;\n    box-shadow: 0 0 0 2px var(--accent-500);\n    position: relative;\n    z-index: 1;\n  }\n\n  /* Input wrapper should fill available height */\n  .groupInputWrapper {\n    display: flex;\n    align-items: stretch;\n    height: 100%;\n    flex: 1;\n  }\n\n  .groupInputWrapper input {\n    height: 100%;\n  }\n\n  /* Fill height for buttons in groups */\n  .itemWrapper .groupItem {\n    display: flex;\n    height: 100%;\n  }\n\n  /* Full width for vertical orientation */\n  .group.vertical .itemWrapper .groupItem {\n    width: 100%;\n  }\n\n  /* Default padding for Group.Select */\n  .groupSelectWrapper {\n    display: flex;\n    align-items: stretch;\n    padding: 0;\n    border: none;\n    background-color: transparent;\n  }\n\n\n  /* Trigger styling for SelectTrigger in Group context */\n  .group.none:not(.ghost) .trigger {\n    border-radius: 0;\n  }\n\n  .trigger {\n    border: none;\n  }\n\n  /* Make Select fill height when in group */\n  .groupSelectWrapper .select {\n    height: 100%;\n    width: 100%;\n  }\n\n  /* Active button state */\n  .groupItem.active {\n    position: relative;\n  }\n\n  /* Active state for ghost variant - restore full button styling */\n  .group.ghost .groupItem.active {\n    border-radius: var(--radius-sm);\n    /* Border is preserved from Button's default variant */\n  }\n\n  /* Active state for other variants */\n  .group:not(.ghost) .groupItem.active {\n    background-color: var(--background-800);\n    font-weight: 500;\n  }\n}\n",
  "input": "@reference \"tailwindcss\";\n\n@layer components {\n  .input {\n    --background: var(--background-950);\n    --foreground: var(--foreground-50);\n    --placeholder: var(--foreground-500);\n    --border: var(--background-700);\n    --background-hover: var(--background-700);\n    --border-hover: var(--background-600);\n    --ring-color: var(--accent-500);\n\n    width: 100%;\n    display: block;\n    font-family: inherit;\n    font-size: var(--text-sm);\n    line-height: var(--leading-snug);\n    color: var(--foreground);\n    background-color: var(--background);\n    border: var(--border-width-base) solid var(--border);\n    border-radius: var(--radius-sm);\n    outline: none;\n    @apply px-3 py-2;\n    transition: transform 150ms var(--ease-snappy-pop), border-color 150ms var(--ease-snappy-pop), box-shadow 150ms var(--ease-snappy-pop), background-color 150ms var(--ease-snappy-pop);\n\n    &::placeholder {\n      color: var(--placeholder);\n    }\n\n    &[data-active] {\n      border-color: var(--ring-color);\n      box-shadow: 0 0 0 3px color-mix(in srgb, var(--ring-color) 20%, transparent);\n    }\n\n    &[data-focus-visible] {\n      @apply ring-0;\n      border-color: var(--ring-color);\n      box-shadow: 0 0 0 3px color-mix(in srgb, var(--ring-color) 20%, transparent);\n    }\n\n    &[data-disabled] {\n      background-color: var(--background-900);\n      color: var(--foreground-500);\n      cursor: not-allowed;\n      opacity: 0.6;\n    }\n\n    &[data-error] {\n      --border: var(--danger-600);\n      --ring-color: var(--danger-600);\n      border-color: var(--danger-600);\n\n      &[data-active] {\n        border-color: var(--danger-600);\n        box-shadow: 0 0 0 3px color-mix(in srgb, var(--danger-600) 20%, transparent);\n      }\n\n      &[data-focus-visible] {\n        border-color: var(--danger-600);\n        box-shadow: 0 0 0 3px color-mix(in srgb, var(--danger-600) 20%, transparent);\n      }\n    }\n\n    /* Hide default browser spinners for number inputs */\n    &[type=\"number\"] {\n      &::-webkit-outer-spin-button,\n      &::-webkit-inner-spin-button {\n        -webkit-appearance: none;\n        margin: 0;\n        display: none;\n      }\n\n      /* Firefox */\n      &[type=\"number\"] {\n        -moz-appearance: textfield;\n      }\n    }\n  }\n\n  .input[data-variant=\"ghost\"] {\n    --background: transparent;\n    --border: transparent;\n    --background-hover: transparent;\n    --border-hover: transparent;\n\n    &[data-focus-visible] {\n      box-shadow: none;\n    }\n  }\n\n  .iconWrapper {\n    position: absolute;\n    top: 50%;\n    display: flex;\n    align-items: center;\n    color: var(--foreground-500);\n    pointer-events: none;\n    transform: translateY(-50%);\n  }\n\n  .prefixIcon {\n    left: 0.60rem;\n  }\n\n  .suffixIcon {\n    right: 1.00rem;\n  }\n\n  .container {\n    position: relative;\n    width: 100%;\n  }\n\n  .numberControls {\n    position: absolute;\n    top: 50%;\n    right: 0.50rem;\n    display: flex;\n    flex-direction: column;\n    gap: 0;\n    height: 1.5rem;\n    transform: translateY(-50%);\n    pointer-events: auto;\n  }\n\n  .numberControls.disabled {\n    opacity: 0.5;\n    cursor: not-allowed;\n  }\n\n  .spinButton {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    flex: 1;\n    width: 1.25rem;\n    padding: 0;\n    background-color: transparent;\n    border: none;\n    color: var(--foreground-500);\n    cursor: pointer;\n    transition: color 150ms var(--ease-snappy-pop);\n\n    &:hover:not(:disabled) {\n      color: var(--foreground-400);\n    }\n\n    &:active:not(:disabled) {\n      color: var(--accent-500);\n    }\n\n    &:disabled {\n      cursor: not-allowed;\n      opacity: 0.5;\n    }\n  }\n}\n",
