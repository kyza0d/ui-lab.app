...
export const generatedStyles: Record<string, { rawCss: string; styleableParts: Array<{ name: string }>; cssVariables: Array<{ name: string; value: string; defaultValue?: string; referencedVars: string[]; variant?: string | null }> }> = {
  ...
  "table": {
    "rawCss": "@reference \"tailwindcss\";\n\n@layer components {\n  .root {\n    @apply w-full;\n  }\n\n  .container {\n    @apply w-full overflow-x-auto rounded-md;\n    border: var(--border-width-base) solid var(--table-border, var(--background-border, var(--border)));\n    background-color: var(--table-container-background, var(--background));\n  }\n\n  .table {\n    @apply w-full text-sm;\n    --table-border: var(--background-border, var(--border));\n    --table-background: var(--background);\n    --table-foreground: var(--foreground);\n    --table-header-background: var(--header-background, var(--background));\n    --table-header-foreground: var(--header-foreground, var(--foreground));\n    --table-body-background: var(--body-background, var(--background));\n    --table-body-background-hover: var(--background-hover, var(--background));\n    --table-row-selected-background: var(--background-selected, var(--background-hover, var(--background)));\n    --table-cell-background: transparent;\n    --table-cell-foreground: var(--cell-foreground, var(--foreground));\n    --table-empty-background: var(--body-background, var(--background));\n    --table-empty-foreground: var(--empty-foreground, var(--foreground));\n    --table-filter-background: var(--background-900, var(--background));\n    --table-filter-border: var(--background-border, var(--border));\n    --table-filter-grid-background: var(--filter-bar-background, var(--body-background, var(--background)));\n    --table-filter-label-foreground: var(--filter-label-foreground, var(--foreground));\n    --table-filter-input-background: var(--background);\n    --table-filter-input-border: var(--background-border, var(--border));\n    --table-filter-input-foreground: var(--foreground);\n    --table-filter-input-placeholder: var(--placeholder);\n    --table-filter-input-ring: var(--ring, var(--focus-visible));\n    display: table;\n    border-collapse: collapse;\n    min-width: max-content;\n    background-color: var(--table-background, transparent);\n    color: var(--table-foreground, var(--foreground));\n    font-size: var(--table-font-size, var(--text-sm));\n  }\n\n  .header {\n    display: table-header-group;\n    background-color: var(--table-header-background, var(--header-background, var(--background)));\n  }\n\n  .body {\n    display: table-row-group;\n    background-color: var(--table-body-background, var(--body-background, var(--background)));\n  }\n\n  .headerRow {\n    display: table-row;\n    background-color: var(--table-header-background, var(--header-background, var(--background)));\n  }\n\n  .headerCell {\n    @apply px-4 py-3 text-left;\n    display: table-cell;\n    background-color: var(--table-header-background, var(--header-background, var(--background)));\n    color: var(--table-header-foreground, var(--header-foreground, var(--foreground)));\n    font-weight: var(--table-header-font-weight, var(--font-weight-semibold));\n    white-space: nowrap;\n    border-bottom: var(--border-width-base) solid var(--table-border, var(--background-border, var(--border)));\n  }\n\n  .headerCell:first-child {\n    border-top-left-radius: var(--radius-sm);\n  }\n\n  .headerCell:last-child {\n    border-top-right-radius: var(--radius-sm);\n  }\n\n  .row {\n    display: table-row;\n    transition:\n      background-color var(--hover-transition-duration, var(--hover-transition-leave-duration, 300ms)) var(--hover-transition-timing-function, var(--ease-snappy-pop, ease-out)),\n      color var(--hover-transition-duration, var(--hover-transition-leave-duration, 300ms)) var(--hover-transition-timing-function, var(--ease-snappy-pop, ease-out));\n  }\n\n  .row[data-interactive=\"true\"] {\n    @apply cursor-pointer;\n  }\n\n  .row[data-interactive=\"true\"]:hover .cell {\n    --hover-transition-duration: var(--hover-transition-enter-duration, 0ms);\n    background-color: var(--table-body-background-hover, var(--background-hover, var(--background)));\n  }\n\n  .row[data-selected=\"true\"] .cell {\n    background-color: var(--table-row-selected-background, var(--background-selected, var(--background-hover, var(--background))));\n  }\n\n  .row[data-disabled=\"true\"] {\n    cursor: not-allowed;\n    opacity: var(--disabled-opacity, 0.5);\n  }\n\n  .row:focus-visible {\n    outline: 2px solid var(--focus-ring);\n    outline-offset: -2px;\n  }\n\n  .interactive {\n    @apply cursor-pointer;\n  }\n\n  .cell {\n    @apply px-4 py-3 align-middle;\n    display: table-cell;\n    background-color: var(--table-cell-background, transparent);\n    color: var(--table-cell-foreground, var(--cell-foreground, var(--foreground)));\n    border-bottom: var(--border-width-base) solid var(--table-border, var(--background-border, var(--border)));\n    transition:\n      background-color var(--hover-transition-duration, var(--hover-transition-leave-duration, 300ms)) var(--hover-transition-timing-function, var(--ease-snappy-pop, ease-out)),\n      color var(--hover-transition-duration, var(--hover-transition-leave-duration, 300ms)) var(--hover-transition-timing-function, var(--ease-snappy-pop, ease-out));\n  }\n\n  .row:last-child .cell {\n    border-bottom: none;\n  }\n\n  .row:last-child .cell:first-child {\n    border-bottom-left-radius: var(--radius-sm);\n  }\n\n  .row:last-child .cell:last-child {\n    border-bottom-right-radius: var(--radius-sm);\n  }\n\n  .emptyRow {\n    border-bottom: none;\n  }\n\n  .emptyState {\n    @apply px-4 py-8 text-center;\n    background-color: var(--table-empty-background, var(--body-background, var(--background)));\n    color: var(--table-empty-foreground, var(--empty-foreground, var(--foreground)));\n  }\n\n  .filterBar {\n    @apply mb-4 rounded-sm border p-4;\n    border: var(--border-width-base) solid var(--table-filter-border, var(--background-border, var(--border)));\n    background-color: var(--table-filter-background, var(--background-900, var(--background)));\n  }\n\n  .filterGrid {\n    @apply grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3;\n    background-color: var(--table-filter-grid-background, var(--filter-bar-background, var(--body-background, var(--background))));\n  }\n\n  .filterField {\n    @apply min-w-0;\n  }\n\n  .filterLabel {\n    @apply mb-2 block;\n    color: var(--table-filter-label-foreground, var(--filter-label-foreground, var(--foreground)));\n    font-size: var(--table-filter-label-font-size, var(--text-xs));\n    font-weight: var(--table-filter-label-font-weight, var(--font-weight-medium));\n  }\n\n  .filterInput {\n    @apply w-full;\n  }\n}\n",
    "styleableParts": [
      {
        "name": "root"
      },
