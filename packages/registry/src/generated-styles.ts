...
export const generatedStyles: Record<string, { rawCss: string; styleableParts: Array<{ name: string }>; cssVariables: Array<{ name: string; value: string; defaultValue?: string; referencedVars: string[]; variant?: string | null }> }> = {
  ...
  "group": {
    ...
    "cssVariables": [
      ...
      {
        "name": "--inner-radius",
        "value": "calc(var(--radius) - var(--group-border-width))",
        "defaultValue": null,
        "referencedVars": [
          "--radius",
          "--group-border-width"
      ...
      },
      {
        ...
        "value": "calc(0.80em * var(--leading-tight, 1.25))",
        "defaultValue": "1.25",
        "referencedVars": [
          "--leading-tight"
        ],
      ...
      {
        "name": "--total-border-height",
        "value": "calc(var(--group-border-width) * 2)",
        "defaultValue": null,
        "referencedVars": [
          "--group-border-width"
        ],
      ...
      {
        "name": "--total-padding-height",
        "value": "calc(var(--padding) * 2)",
        "defaultValue": null,
        "referencedVars": [
          "--padding"
        ],
      ...
      },
      {
        ...
        "defaultValue": null,
        "referencedVars": [],
        "variant": ".group:not(.ghost).none :is(.group-item, .trigger, .group-select-wrapper)"
      },
      {
        "name": "--inner-radius",
        "value": "0",
      ...
      },
      {
        ...
        "defaultValue": null,
        "referencedVars": [],
        "variant": ".group:not(.ghost).none .group-input-wrapper"
      },
      {
        "name": "--input-border-radius",
        ...
        "variant": ".group:not(.ghost):is(.xs, .sm) .group-input-wrapper"
      },
      {
        "name": "--radius",
        "value": "0",
        "defaultValue": null,
        "referencedVars": [],
        "variant": ".group.ghost.none :is(.group-item, .group-select-wrapper)"
      },
      {
        "name": "--inner-radius",
        "value": "0",
